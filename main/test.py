...
def folder_structure_to_json(folder_path, output_file):
...
# Example usage
folder_path = 'libs'  # Replace with the path to the folder you want to describe
output_file = Path('data') / 'folder_structure.json'  # Construct the output file path using Pathlib

folder_structure_to_json(folder_path, output_file)
print(f"Folder structure with last modification times in epoch format saved to {output_file}.")
